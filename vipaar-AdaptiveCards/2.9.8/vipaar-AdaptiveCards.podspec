Pod::Spec.new do |spec|
  spec.name             = 'vipaar-AdaptiveCards'
  ...
  spec.authors          = { 'vipaar-AdaptiveCards' => 'Joseph.Woo@microsoft.com' }

  spec.summary          = 'Adaptive Cards are a new way for developers to exchange card content in a common and consistent way'
  
  spec.source       = { :git => 'https://github.com/microsoft/AdaptiveCards-Mobile.git', :tag => 'iOS/adaptivecards-ios@2.9.8' }
  ...
  spec.subspec 'AdaptiveCardsCore' do | sspec |
    ...
    sspec.dependency 'vipaar-SVGKit', '>= 3.1.0'
  end
