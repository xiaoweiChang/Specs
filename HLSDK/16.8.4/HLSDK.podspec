Pod::Spec.new do |s|
  ...
  s.source       = {
    ...
    :sha1 => "9493e4d882dc966d1414c2fa3af5893c70a84b76"
  }
  s.source_files = ''
  s.requires_arc = true
  s.platform                  = :ios
  ...
  s.subspec 'Main' do |m|
    ...
    m.ios.dependency 'OTXCFramework', '2.25.2'
    ...
    m.ios.dependency 'Kingfisher', '5.15.8'
    ...
    m.ios.dependency 'TwilioConversationsClient', '2.0.3'
    m.ios.dependency 'TwilioAccessManager', '1.1.2'
    ...
    m.ios.dependency 'KMPlaceholderTextView', '1.4.0'
    ...
    m.vendored_frameworks       = 'HLSDKLogging.framework', 'HLSDKBufferRing.framework', 'HLSDKDarwinNotification.framework', 'HLSDKCommon.framework', 'HLSDKBrokerSwift.framework', 'HLSDK.framework', 'FBSDK.framework', 'HLSDKUI.framework'
    ...
    m.user_target_xcconfig      = {
      ...
      'OTHER_LDFLAGS'          => '-licucore -framework "JRE" -framework "HLSDKBrokerSwift" -framework "FBSDK" -framework "HLSDK" -framework "HLSDKLogging" -framework "HLSDKBufferRing" -framework "HLSDKDarwinNotification" -framework "HLSDK" -framework "HLSDKCommon" -framework "HLSDKUI"',
