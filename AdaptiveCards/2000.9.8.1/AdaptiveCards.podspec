Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => 'ssh://git@github.com/microsoft/AdaptiveCards-Mobile.git', :tag => 'iOS/adaptivecards-ios@2.9.8' }
    ...
    spec.subspec 'AdaptiveCardsCore' do | sspec |
      ...
      sspec.dependency 'SVGKit', '3000.0.0'
    end
    ...
    spec.subspec 'UIProviders' do | sspec |
      ...
      sspec.dependency 'vipaar-MicrosoftFluentUI', '0.3.9.1'
