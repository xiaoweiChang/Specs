Pod::Spec.new do |s|
    ...
    s.vendored_frameworks       = 'HLSDK.framework', 'HLSDKSwift.framework'
    ...
    s.ios.dependency 'PromisesSwift', '1.2.8'
    ...
    s.pod_target_xcconfig       = {
      ...
      'HEADER_SEARCH_PATHS'    => '"$(PODS_ROOT)/HLSDKSwift/distributive/HLSDK.framework/Headers"',
      'OTHER_LDFLAGS'          => '-licucore -framework JRE -force_load \""$(PODS_ROOT)"/HLSDKSwift/distributive/HLSDK.framework/HLSDK\"'
    }
